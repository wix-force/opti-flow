          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[70px] items-center">
            ...
            >
              <div className="mb-8">
                ...
                <p className="font-heading text-xs uppercase tracking-widest text-black font-bold mb-4">Adjust your hourly $ rate and hours spent on messy workflows to see your potential savings.</p>
