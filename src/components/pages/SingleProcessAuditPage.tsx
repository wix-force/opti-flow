  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-paragraph selection:bg-primary selection:text-white">
      ...
      <section className="relative w-full min-h-[60vh] flex flex-col justify-center pt-16 pb-12 md:pb-16 bg-background">
        ...
        <div className="w-full max-w-[100rem] mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <motion.div
          ...
          <motion.p
            ...
            className="font-paragraph text-sm md:text-base text-text-body mb-8 max-w-2xl leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="flex flex-col md:flex-row gap-3 items-start md:items-center flex-wrap"
          >
            <Button 
      ...
      <section className="w-full py-12 md:py-16 px-6 md:px-12 lg:px-24 bg-background border-b border-[#E5E5E5]">
        <div className="w-full max-w-[100rem] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[30%_70%] gap-8">
            {/* Left Column - Title (30%) */}
            <div>
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground leading-tight text-left">
            ...
            <div className="space-y-3 text-foreground text-left">
              ...
              <ul className="space-y-2 list-none">
                <li className="flex gap-3">
                  ...
                  <span className="font-paragraph text-sm md:text-base leading-relaxed">
              ...
              <p className="font-paragraph text-sm md:text-base leading-relaxed pt-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-4 md:p-5 bg-[#F4F4F4] rounded-md text-left"
              >
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={index} className="flex gap-3 text-left">
                ...
                <div>
                  <h3 className="font-heading text-base md:text-lg font-bold text-foreground mb-0.5">
                    {item.title}
                  </h3>
                  <p className="font-paragraph text-sm md:text-base text-foreground leading-relaxed">
                    {item.description}
      ...
      <section className="w-full py-12 md:py-16 px-6 md:px-12 lg:px-24 bg-background border-b border-[#E5E5E5]">
        <div className="w-full max-w-[100rem] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[30%_70%] gap-8">
            {/* Left Column */}
            <div>
              <h3 className="font-heading text-lg md:text-xl font-bold text-foreground leading-tight text-left">
                Scope Definition
              </h3>
            </div>
            ...
            <div className="space-y-4 text-left">
              <div>
                <h4 className="font-heading text-sm md:text-base font-bold text-foreground mb-1.5 uppercase tracking-[0.15em]">
            ...
            {faqItems.map((item, index) => (
              <div key={index}>
                ...
                {expandedFaq === index && (
                  ...
                  >
                    <p className="font-paragraph text-sm md:text-base text-[#666666] leading-relaxed">
                      {item.body}
                    </p>
                  </motion.div>
                )}
      ...
      {/* Bottom CTA Section */}
      <section className="w-full py-12 md:py-16 px-6 md:px-12 lg:px-24 bg-primary text-white">
        <div className="w-full max-w-[100rem] mx-auto">
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight text-left">
            Ready to Reclaim <br />
            Your Time?
          </h2>
          <p className="font-paragraph text-base md:text-lg mb-6 leading-relaxed opacity-90 max-w-2xl">
